...
// Importe le contenu des éléments standards de l'interface
// Importe le contenu de l'élément "carte"
require_once "card.php";
// Importe le contenu de l'élément "form"
require_once "form.php";
// Importe le contenu de l'élément "select"
require_once "select.php";
// Importe le contenu de l'élément "textbox
require_once "textbox.php";

// Importe le contenu des éléments plus spécifique de l'interface
// Importe le contenu de l'élément correspondant au pied de page
